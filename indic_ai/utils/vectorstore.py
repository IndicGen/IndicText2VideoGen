...
class VectorStoreHandler:
    ...
    def get_best_match(self, query: str):
        ...
        try:
            ...
            logger.info(f"Best matching case id: {best_case_id} with similarity: {best_similarity:.4f}")
    ...
    def search_documents(self, case_id: str, query: str, top_k: int = 3):
        ...
        results = self.collection.query(query_embeddings=[query_embedding], n_results=top_k, where={"case_id": best_match})
